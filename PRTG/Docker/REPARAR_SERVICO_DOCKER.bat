...
echo ip  = '10.11.100.39' >> "C:\Program Files\Python37\reparaservicos\deploy\docker\%mypath%.py"
echo usuario = '99936' >> "C:\Program Files\Python37\reparaservicos\deploy\docker\%mypath%.py"
